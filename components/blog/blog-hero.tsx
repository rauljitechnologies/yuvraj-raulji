  ...
  return (
    <section className="relative bg-bg overflow-hidden flex flex-col" style={{ minHeight: '100vh' }}>
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        <div style={{ position: 'absolute', inset: 0, background: 'radial-gradient(ellipse 65% 80% at -5% 45%,rgba(200,16,46,.22) 0%,transparent 100%)' }} />
        ...
        <div
          ...
          style={{ ...bebas, right: '-2%', bottom: '-4%', fontSize: '38vw', lineHeight: 1, color: 'rgba(200,16,46,.045)', letterSpacing: '-.02em', animation: 'shimmer 5s ease-in-out infinite' }}
        >
          2026
        </div>
            ...
            <div className="flex flex-col justify-between py-6 lg:py-10 reveal">
              <div>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 24 }}>
                  ...
                  <span style={{ fontSize: '.54rem', fontWeight: 700, letterSpacing: '.30em', textTransform: 'uppercase', color: 'rgba(200,16,46,.55)', whiteSpace: 'nowrap', flexShrink: 0 }}>
                    Vadodara, India
                  </span>
                </div>

                <p style={{ fontSize: 'clamp(.96rem,1.25vw,1.10rem)', lineHeight: 1.82, color: 'rgba(244,244,244,.52)', maxWidth: 430 }}>
                  In-depth guides from <strong style={{ color: '#f4f4f4', fontWeight: 600 }}>9+ years</strong> hands-on experience — Magento 2, SEO &amp; CRO, AWS infrastructure, WordPress performance, and AI automation.
                </p>
              </div>
              ...
              <div>
                ...
                <div className="flex items-end justify-between flex-wrap gap-6">
                  <div className="flex items-center gap-8">
                    {STATS.map((s, i) => (
                      <div key={s.l} className="flex items-center gap-8">
                        ...
                        <div>
                          <div style={{ ...bebas, fontSize: 'clamp(2rem,4vw,2.8rem)', lineHeight: 1, color: '#e8192c' }}>{s.v}</div>
                          <div style={{ fontSize: '.58rem', fontWeight: 700, letterSpacing: '.22em', textTransform: 'uppercase', color: 'rgba(244,244,244,.36)', marginTop: 3 }}>
                            {s.l}
                          </div>
                        </div>
                      </div>
                  ...
                  >
                    <span className="group-hover:!text-rv" style={{ fontSize: '.68rem', fontWeight: 700, letterSpacing: '.28em', textTransform: 'uppercase', color: 'rgba(244,244,244,.26)', transition: 'color .3s' }}>
                      Explore
                    </span>
                    <div
            ...
            <div className="relative lg:py-10 reveal" style={{ animationDelay: '.18s' }}>
              ...
              >
                ...
                <div
                  ...
                  style={{ boxShadow: 'inset 0 0 0 1px rgba(200,16,46,.35),0 0 80px rgba(200,16,46,.12)' }}
                />
                ...
                <div className="absolute top-6 left-6 right-6 flex items-center justify-between">
                  <span
                    style={{
                      ...
                      letterSpacing: '.18em',
                      textTransform: 'uppercase',
                      boxShadow: '0 6px 20px rgba(232,25,44,.45)',
                    }}
                  >
                    ★ Latest Article
                  </span>
                ...
                <div className="absolute bottom-0 left-0 right-0 p-7 lg:p-9">
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
                    ...
                    <span style={{ fontSize: '.60rem', fontWeight: 600, letterSpacing: '.14em', textTransform: 'uppercase', color: 'rgba(244,244,244,.38)' }}>08 Jun 2026</span>
                  </div>
                  <h2
                    className="group-hover:text-rv"
                    style={{ ...bebas, fontSize: 'clamp(1.9rem,3.2vw,3rem)', lineHeight: 0.93, letterSpacing: '.02em', textTransform: 'uppercase', color: '#f4f4f4', marginBottom: 14, transition: 'color .3s' }}
                  >
                    AI for E-commerce in 2026:
                    <br />
                    Real Use Cases That Drive Revenue
                  </h2>
                  <p style={{ fontSize: '.90rem', lineHeight: 1.7, color: 'rgba(244,244,244,.52)', maxWidth: 460, marginBottom: 22 }}>
                  ...
                  <span
                    ...
                    style={{ display: 'inline-flex', alignItems: 'center', gap: 8, fontSize: '.72rem', fontWeight: 700, letterSpacing: '.14em', textTransform: 'uppercase', color: '#e8192c' }}
                  >
